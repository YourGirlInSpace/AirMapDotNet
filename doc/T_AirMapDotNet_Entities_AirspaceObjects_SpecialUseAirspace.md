...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_AirMapDotNet_Entities_AirspaceObjects_AirspaceObject">AirMapDotNet.Entities.AirspaceObjects.AirspaceObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;AirMapDotNet.Entities.AirspaceObjects.SpecialUseAirspace<br />
...
**C#**<br />
``` C#
public class SpecialUseAirspace : AirspaceObject
```
...
**C++**<br />
``` C++
public ref class SpecialUseAirspace : public AirspaceObject
```

**F#**<br />
``` F#
type SpecialUseAirspace =  
    class
        inherit AirspaceObject
    end
```

The SpecialUseAirspace type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_AirMapDotNet_Entities_AirspaceObjects_SpecialUseAirspace__ctor">SpecialUseAirspace</a></td><td>
Initializes a new instance of the SpecialUseAirspace class</td></tr></table>&nbsp;
<a href="#specialuseairspace-class">Back to Top</a>
...
The state where this object exists.
 (Inherited from <a href="T_AirMapDotNet_Entities_AirspaceObjects_AirspaceObject">AirspaceObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_AirMapDotNet_Entities_AirspaceObjects_SpecialUseAirspace_SUAType">SUAType</a></td><td>
The type of Special Use Airspace.</td></tr></table>&nbsp;
<a href="#specialuseairspace-class">Back to Top</a>
