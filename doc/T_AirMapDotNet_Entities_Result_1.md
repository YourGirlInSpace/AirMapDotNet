...
Represents a JSend API result with data object *T*.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_AirMapDotNet_Entities_Result">AirMapDotNet.Entities.Result</a><br />&nbsp;&nbsp;&nbsp;&nbsp;AirMapDotNet.Entities.Result(T)<br />
...
**VB**<br />
``` VB
Public Class Result(Of T As {Class, IAirMapEntity})
	Inherits Result
```
...
**F#**<br />
``` F#
type Result<'T when 'T : not struct and IAirMapEntity> =  
    class
        inherit Result
    end
```
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>The underlying type representing the JSend "data" property.</dd></dl>&nbsp;
The Result(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_AirMapDotNet_Entities_Result_1__ctor">Result(T)</a></td><td>
Initializes a new instance of the Result(T) class</td></tr></table>&nbsp;
