...
namespace AirMapDotNet
{
    ...
    public class APIConfiguration
    {
        ...
        /// <permission cref="FileIOPermission">Requires <see cref="FileIOPermissionAccess.Read"/> access to <paramref name="path"/>.</permission>
        public static async Task<APIConfiguration> LoadFromFileAsync(string path)
        {
            ...
            FileIOPermission perm = new FileIOPermission(FileIOPermissionAccess.Read, absPath);
            perm.Demand();
