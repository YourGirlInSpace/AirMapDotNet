namespace AirMapDotNet.Services
{
    ...
    /// </summary>
    public class AirMapService : IAirMapService
    {
#if DEBUG
        ...
        /// </summary>
        internal const string AirMap_Telemetry_BaseURL = "api-udp-telemetry.prod.airmap.com";
        /// <summary>
        /// Telemetry server UDP port.
        /// </summary>
        internal const int AirMap_Telemetry_Port = 16060;
        #endregion
        #endregion
