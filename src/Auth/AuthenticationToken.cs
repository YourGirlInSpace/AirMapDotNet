...
namespace AirMapDotNet.Authentication
{
    ...
    /// </summary>
    /// <remarks>
    /// The Authentication Token is the ID token returned through the AirMap Javascript Authentication library.  It is a JWT token that does not require signature validation.</remarks>
