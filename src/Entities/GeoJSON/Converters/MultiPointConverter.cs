...
{
    internal sealed class MultiPointConverter : JsonConverter
    {
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            MultiPoint mpf = value as MultiPoint;

            if (mpf == null)
                throw new AirMapException($"Failed to write GeoJSON:  {nameof(value)} is not a MultiPointFeature!");
        ...
        public override bool CanConvert(Type objectType) => objectType == typeof(MultiPoint);
    }
}